...
<div id="app" class="font-sans pb-20"> <!-- 增加底部 padding 以容納新增按鈕 -->
    ...
    <main class="p-4 pt-6">
        ...
        <!-- 春節期間總覽與特別提醒 (新增區塊) -->
        <div class="bg-red-50 p-6 rounded-xl shadow-inner border border-red-300 mb-8">
            <h2 class="text-xl font-bold text-red-800 flex items-center border-b pb-2 mb-3">
            ...
            <ul class="list-disc pl-5 space-y-2 text-sm text-gray-700">
                <li>**交通：** 高鐵票務必提前搶購，尤其上海往返杭州的熱門時段。</li>
                <li>**餐飲：** 除夕、初一很多小店和非連鎖餐廳會休息，請預先確認營業資訊或選擇飯店內用餐。</li>
                <li>**景點關門時間：** 除夕當日 (2/16) 很多景點會提早至 **15:00-16:00** 關門，務必將重要景點排在上午。</li>
                <li>**人流：** 烏鎮西柵、西湖、寒山寺等景區人潮將達到平日的數倍，搖櫓船、遊船等服務可能需大排長龍，請保持耐心。</li>
                <li>**住宿：** 烏鎮西柵等熱門景區內住宿價格會大幅上漲，且一房難求，建議提早預訂。</li>
            </ul>
        </div>
        ...
        <!-- 景點簡介區塊 (新增) -->
        <div v-if="currentDay.generalAttractionIntro" 
             class="p-4 bg-mint-light border-l-4 border-accent text-gray-800 rounded-xl mb-6 flex items-start text-sm transition-colors duration-300"
        >
            <svg class="w-5 h-5 mr-2 flex-shrink-0 mt-0.5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.207 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.832 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.793 5 16.5 5s3.332.477 4.5 1.253v13C19.832 18.477 18.168 18 16.5 18s-3.332.477-4.5 1.253"></path></svg>
            <div>
                <strong class="block mb-1 text-gray-900">【景點簡介】:</strong>
                <span>{{ currentDay.generalAttractionIntro }}</span>
            </div>
        </div>
        ...
        >
            ...
            <div>
                <strong class="block mb-1 text-red-900">當日春節特別注意事項:</strong>
    ...
    const fullItineraryData = [
        {
            ...
            weather: '多雲轉陰',
            temp: '3°C ~ 8°C',
            generalAttractionIntro: '山塘街有「姑蘇第一名街」之稱，保留了原汁原味的古街風貌，夜間燈光璀璨，是蘇州夜遊的重點。',
        ...
        },
        {
            ...
            weather: '陰天',
            temp: '3°C ~ 7°C',
            generalAttractionIntro: '拙政園是蘇州園林之首，江南園林的代表作。蘇州博物館由貝聿銘設計，是現代建築與古典園林的完美結合。平江路是蘇州最古老的水巷，充滿小橋流水人家的雅致情調。',
        ...
        },
        {
            ...
            weather: '多雲',
            temp: '4°C ~ 9°C',
            generalAttractionIntro: '虎丘享有「吳中第一名勝」的美譽，有著名的虎丘塔，景色宜人。金雞湖則是現代蘇州的象徵，周邊商場林立，適合購物與休閒。',
        ...
        },
        {
            ...
            weather: '小雨',
            temp: '2°C ~ 6°C',
            generalAttractionIntro: '烏鎮西柵是典型的江南水鄉古鎮，保留了明清古建築群。入夜後，西柵的燈光將小橋流水映照得如夢似幻，夜景是其精華。',
        ...
        },
        {
            ...
            weather: '多雲',
            temp: '4°C ~ 10°C',
            generalAttractionIntro: '西湖被譽為人間天堂，有三潭印月、斷橋殘雪等十大景點。建議租用電瓶車或步行環湖，享受湖光山色。',
        ...
        },
        {
            ...
            weather: '晴時多雲',
            temp: '5°C ~ 12°C',
            generalAttractionIntro: '千島湖以其 1078 座翠島而聞名，湖水清澈，風景壯麗，適合乘船登島遊覽。是遠離城市喧囂的自然選擇。',
        ...
        },
        {
            ...
            weather: '多雲',
            temp: '6°C ~ 10°C',
            generalAttractionIntro: '返程日主要以交通為主，建議在飯店周邊自由活動，輕鬆購物伴手禮，為下午的長途移動做準備。',
